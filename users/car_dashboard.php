...
<head>
    ...
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .sidebar {
        ...
        z-index:100; transition:background 0.35s;
        overflow-y:auto;
    }
    ...
    .sb-section {
        ...
        text-transform:uppercase; color:rgba(232,237,245,0.22);
    ...
    .welcome-banner::after {
        ...
        background:radial-gradient(circle, var(--accentglow), transparent 70%);
        pointer-events:none;
    }
    .wb-text h2 {
    ...
    .sc:nth-child(2){ animation-delay:0.16s; }
    .sc:nth-child(3){ animation-delay:0.22s; }
    ...
    .view-all {
        ...
        border:1px solid var(--accentglow);
        transition:all 0.2s;
    }
    ...
    th {
        ...
        color:var(--text3); padding:0 18px 11px;
        text-align:left; border-bottom:1px solid var(--border);
        white-space:nowrap;
    }
    td {
        padding:13px 18px; font-size:0.845rem;
    ...
    .cta-card {
        ...
        border:1px solid var(--border);
        position:relative; overflow:hidden;
        opacity:0; animation:fadeUp 0.5s ease 0.34s forwards;
    }
    .cta-card::before {
        content:''; position:absolute; inset:0;
        background:linear-gradient(135deg, rgba(0,212,255,0.07), rgba(0,144,255,0.04));
        pointer-events:none;
    }
    .cta-card::after {
    ...
    .cta-link {
        ...
        box-shadow:0 3px 12px var(--accentglow);
        position:relative; z-index:1;
    }
    ...
    .update-btn {
        ...
        padding:11px; border:1px dashed var(--border2);
...
<div class="main">
    ...
    <div class="body">
        ...
        <div class="welcome-banner">
            ...
            <a href="../index.php" class="wb-btn">
                <i class="fa fa-car-side"></i> Browse Cars
            </a>
        </div>
        ...
        <div class="stats-grid">
            <div class="sc">
                <div class="sc-icon" style="background:var(--accentbg);color:var(--accent);">
                    <i class="fa fa-receipt"></i>
                </div>
                <div>
                    <div class="sc-num"><?php echo $total_bookings; ?></div>
                    <div class="sc-lbl">Total Bookings</div>
                </div>
            </div>
            <div class="sc">
                <div class="sc-icon" style="background:var(--greenbg);color:var(--green);">
                    <i class="fa fa-circle-check"></i>
                </div>
                <div>
                    <div class="sc-num"><?php echo $active_rentals; ?></div>
                    <div class="sc-lbl">Confirmed</div>
                </div>
            </div>
            <div class="sc">
                <div class="sc-icon" style="background:var(--amberbg);color:var(--amber);">
                    <i class="fa fa-clock"></i>
                </div>
                <div>
                    <div class="sc-num"><?php echo $pending_bookings; ?></div>
        ...
        <div class="content-grid">
            ...
            <div class="card">
                ...
                <table>
                    <thead>
                        <tr><th>Car</th><th>From</th><th>To</th><th>Status</th></tr>
                    </thead>
                    <tbody>
                    <?php if ($bookings_result && $bookings_result->num_rows > 0):
                        while ($b = $bookings_result->fetch_assoc()):
                            $img = !empty($b['Vimage1'])
                                ? "../admin/img/vehicleimages/" . htmlspecialchars($b['Vimage1'])
                                : "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=80&q=60";
                        ...
                        <td>
                            <div class="car-cell">
                                <img src="<?php echo $img; ?>" class="car-thumb" alt="car"
                                     onerror="this.src='https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=80&q=60'">
                                <div>
                                    <div class="car-name"><?php echo htmlspecialchars($b['car_name']); ?></div>
                                    <div class="car-type"><?php echo htmlspecialchars($b['car_type']); ?></div>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr><td colspan="4">
                        <div class="empty-state">
                            <i class="fa fa-car"></i>
                            No bookings yet. <a href="../index.php">Browse cars</a>
                        </div>
                    </td></tr>
                    <?php endif; ?>
                    </tbody>
            ...
            <div class="side-cards">
                ...
                <div class="cta-card">
                    ...
                    <a href="../index.php#contact" class="cta-link">
                        <i class="fa fa-paper-plane"></i> Contact Support
                    </a>
                </div>
                ...
                <div class="status-card">
                    ...
                    <a href="profile.php" class="update-btn">
                        <i class="fa fa-plus" style="margin-right:5px;"></i> Update Documents
                    </a>
                </div>
...
<script>
    ...
    // Theme — same key 'cfyTheme' as login page
