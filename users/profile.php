...
<head>
    ...
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .ps-header {
        ...
        background:linear-gradient(160deg, var(--accentbg), transparent);
        border-bottom:1px solid var(--border);
    ...
    .ps-avatar {
        ...
        box-shadow:0 0 0 4px var(--surface), 0 0 0 6px var(--border2), 0 0 24px var(--accentglow);
        position:relative;
    }
    .ps-avatar .online-ring {
    ...
    .ps-btn-primary {
        background:linear-gradient(135deg,var(--accent),var(--accent2));
        color:#fff; box-shadow:0 3px 12px var(--accentglow);
    }
    ...
    @media(max-width:960px) {
        ...
        .info-field.full { grid-column:span 1; }
    }
        ...
        <div class="profile-grid">
            ...
            <div class="profile-summary">
                ...
                <div class="ps-actions">
                    <a href="edit_profile.php" class="ps-btn ps-btn-primary">
                        <i class="fa fa-pen"></i> Edit Profile
                    </a>
                    <a href="change_password.php" class="ps-btn ps-btn-outline">
                        <i class="fa fa-key"></i> Change Password
                    </a>
                    <a href="logout.php" class="ps-btn ps-btn-danger">
            ...
            <div>
                <div class="info-card">
                    ...
                    <div class="info-body">
                        <div class="info-grid">
                            ...
                            <div class="info-field">
                                ...
                                <div class="field-value">
                                    ...
                                    <?php echo $user_name !== 'User' ? htmlspecialchars($user_name) : '<span>Not provided</span>'; ?>
                                </div>
                            </div>
                            ...
                            <div class="info-field">
                                ...
                                <div class="field-value">
                                    ...
                                    <?php echo $user_phone !== 'Not provided' ? htmlspecialchars($user_phone) : '<span>Not provided</span>'; ?>
                                </div>
                            </div>
                        ...
                        <div style="display:flex;gap:12px;flex-wrap:wrap;padding-top:20px;border-top:1px solid var(--border);">
                            <a href="edit_profile.php" class="ps-btn ps-btn-primary" style="flex:1;min-width:140px;">
                                <i class="fa fa-pen-to-square"></i> Update Profile
                            </a>
                            <a href="change_password.php" class="ps-btn ps-btn-outline" style="flex:1;min-width:140px;">
                ...
                <div class="danger-zone">
                    ...
                    <a href="logout.php" class="dz-btn">
                        <i class="fa fa-arrow-right-from-bracket"></i> Logout Now
                    </a>
                </div>
            </div>
...
<script>
    ...
    // Theme — cfyTheme key (shared across all user pages)
