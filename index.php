...
<head>
    ...
    [data-theme="dark"] .hero::before {
        background-image:
            ...
            linear-gradient(90deg, rgba(79,142,247,0.04) 1px, transparent 1px) !important;
    }
    [data-theme="dark"] .hero::after {
        background: radial-gradient(circle, rgba(79,142,247,0.07) 0%, transparent 70%) !important;
    }
    ...
    [data-theme="dark"] #chatBtn {
        background: linear-gradient(135deg, #4f8ef7, #2563eb);
        box-shadow: 0 4px 24px rgba(79,142,247,0.4);
        animation: chatPulseDark 3s ease infinite;
    }
    @keyframes chatPulseDark {
        0%,100% { box-shadow: 0 4px 24px rgba(79,142,247,0.4), 0 0 0 0 rgba(79,142,247,0.3); }
        50%      { box-shadow: 0 4px 24px rgba(79,142,247,0.4), 0 0 0 12px rgba(79,142,247,0); }
    }
    ...
    [data-theme="dark"] .btn-primary {
        background: #4f8ef7; color: #0d1117;
    ...
    [data-theme="dark"] .form-group textarea:focus { border-color: #4f8ef7; box-shadow: 0 0 0 3px rgba(79,142,247,0.12); }
    [data-theme="dark"] .filter-bar select:focus { border-color: #4f8ef7; }
    [data-theme="dark"] ::-webkit-scrollbar-thumb { background: #2d4a72; }

    /* ── LIGHT MODE: calm slate-blue palette, accent: professional blue ── */
    [data-theme="light"] {
        --bg:         #f0f4f8;
        --bg2:        #e8edf3;
        --bg3:        #dde3ec;
    ...
    [data-theme="light"] #chatBtn {
        background: linear-gradient(135deg, #2563eb, #1d4ed8);
        box-shadow: 0 4px 24px rgba(37,99,235,0.35);
        animation: chatPulseBlue 3s ease infinite;
    }
    @keyframes chatPulseBlue {
        0%,100% { box-shadow: 0 4px 24px rgba(37,99,235,0.35), 0 0 0 0 rgba(37,99,235,0.3); }
        50% { box-shadow: 0 4px 24px rgba(37,99,235,0.35), 0 0 0 12px rgba(37,99,235,0); }
    }
    ...
    [data-theme="light"] .form-group textarea:focus { border-color: #2563eb; box-shadow: 0 0 0 3px rgba(37,99,235,0.12); }
    ...
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .nav-links li.active a::after { width: 60%; }
    ...
    /* Action icon buttons inside pill */
    .user-pill-action {
    ...
    /* Keep these for any other use, but pill replaces them in nav */
    .btn-dashboard {
        display: inline-flex; align-items: center; gap: 7px;
    ...
    [data-theme="light"] .hero::before {
        background-image:
            linear-gradient(rgba(154,120,41,0.06) 1px, transparent 1px),
            linear-gradient(90deg, rgba(154,120,41,0.06) 1px, transparent 1px);
    }
    ...
    .contact-info {
        background: linear-gradient(160deg, #18120a, #2a1f0d);
        padding: 56px 44px;
        position: relative;
        overflow: hidden;
    }
    ...
    @keyframes chatPulse {
        ...
        50% { box-shadow: 0 4px 24px var(--accent-glow), 0 0 0 12px rgba(201,168,76,0); }
    }
    ...
    #chatBtn .badge {
        ...
        width: 20px; height: 20px; font-size: 0.6rem;
        display: flex; align-items: center; justify-content: center;
    ...
    .chat-header {
        background: linear-gradient(135deg, #18120a, #2a1f0d);
        padding: 18px 20px;
    ...
    .chat-close {
        ...
        font-size: 1rem; padding: 4px; margin-left: auto;
        transition: color 0.2s;
    }
    ...
    .msg.bot .msg-avatar { background: var(--gold-dim); color: var(--gold); }
    ...
    .msg.user .msg-bubble {
        background: linear-gradient(135deg, var(--gold), #a8722a);
        color: #0a0a0b; border-bottom-right-radius: 4px;
        font-weight: 500;
    }
    ...
    #chatInput {
        flex: 1; border: 1px solid var(--border2); border-radius: 22px;
    ...
    #chatSend {
        width: 38px; height: 38px;
        background: linear-gradient(135deg, var(--gold), #a8722a);
        border: none; border-radius: 50%; color: #0a0a0b;
    ...
    .loader-logo {
        ...
        color: #f0ede8; letter-spacing: 0.05em;
    }
    ...
    @media (max-width: 900px) {
        ...
        /* On mobile, hide auth-controls from the top bar — show a login link inside the nav dropdown instead */
...
<header id="siteHeader">
    <div class="container">
        <nav>
            ...
            <!-- Auth controls — lives in nav, NOT inside the ul -->
            <div class="auth-controls">
                ...
                ?>
                    <div class="user-pill">
                        ...
                        <a href="users/car_dashboard.php" class="user-pill-action" title="Dashboard">
                            <i class="fa fa-table-columns"></i>
                        </a>
                        <a href="users/logout.php" class="user-pill-action user-pill-logout" title="Logout">
                            <i class="fa fa-arrow-right-from-bracket"></i>
                        </a>
                    </div>
                <?php else: ?>
                    <a href="users/login.php" class="btn-login">
        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-badge">
                    <span>Premium Fleet • Sri Lanka</span>
                </div>
                <h1>Find Your<br><em>Perfect Ride</em></h1>
                <p>From luxury sedans to rugged SUVs, find the best deals on car rentals for your next adventure. No hidden charges — ever.</p>
                <div class="hero-btns">
                    <button class="btn btn-primary" onclick="showPage('listing')">
                        <i class="fa fa-car"></i> Browse Fleet
                    </button>
                    <button class="btn" onclick="showPage('about')">
        ...
        <div class="container">
            ...
            <div class="testimonial-grid">
                <div class="testimonial-card reveal reveal-delay-1">
                    ...
                    <p>"The car was delivered to my doorstep in perfect condition. Incredible service and very transparent pricing. Best in Sri Lanka!"</p>
                    <div class="user-info">
                ...
                <div class="testimonial-card reveal reveal-delay-2">
                    <div class="stars">★★★★★</div>
                    <i class="fa fa-quote-right quote-icon"></i>
                    <p>"I rented the Defender for a trip to Nuwara Eliya. The vehicle handled the terrain perfectly. Highly recommend their SUV fleet."</p>
                    <div class="user-info">
                ...
                <div class="testimonial-card reveal reveal-delay-3">
                    <div class="stars">★★★★★</div>
                    <i class="fa fa-quote-right quote-icon"></i>
                    <p>"Affordable luxury. Booking the Porsche was a dream come true for my wedding anniversary. Truly a premium experience."</p>
                    <div class="user-info">
                ...
                <div class="about-text reveal reveal-delay-1">
                    ...
                    <div class="about-stats">
                        <div class="about-stat">
                            <h4>40+</h4><p>Years of Experience</p>
                        </div>
                        <div class="about-stat">
                            <h4>1200+</h4><p>Active Fleet</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="contact-container reveal">
                <div class="contact-info">
                    ...
                    <div class="info-item">
                        ...
                        <div><h4>Call Us</h4><p>+94 75 45 57 624</p></div>
                    </div>
                    <div class="info-item">
                        <i class="fa fa-envelope"></i>
                        <div><h4>Email Us</h4><p>amafzhar@gmail.com</p></div>
                    </div>
                    <div class="info-item">
                        <i class="fa fa-location-dot"></i>
                        <div><h4>Head Office</h4><p>37 Kinniya, Trincomalee, Sri Lanka</p></div>
                    </div>
...
<footer>
    <div class="container">
        ...
        <div class="footer-bottom">
            ...
            <p style="color:var(--text3);font-size:0.78rem;">Designed with ♥ in Sri Lanka</p>
        </div>
    </div>
</footer>
...
<script>
    // ── PAGE NAVIGATION ──────────────────────────────────────────────────
    // ── PAGE ORDER — defines what "back" means for each page ─────────────
    // back button goes: contact → listing → about → home
    var PAGE_ORDER = ['home', 'about', 'listing', 'contact'];

    // Internal render — never pushes history (used by popstate)
    ...
    // Public navigation — pushes a history state so back button works
    function showPage(pageId) {
        // Replace state for home so back from home exits the site normally
        if (pageId === 'home') {
    ...
    window.addEventListener('popstate', function(e) {
        if (e.state && e.state.page) {
            ...
            // No state means we popped past our entries — show home
            renderPage('home');
        }
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Read page from URL hash on load (supports direct links like index.php#listing)
        var hash = window.location.hash.replace('#', '');
        var startPage = (hash && PAGE_ORDER.indexOf(hash) !== -1) ? hash : 'home';

        // Seed the history stack so back works from the first page visited
    ...
    function applyFilters() {
        ...
        cards.forEach(function(card) {
            ...
            card.style.display = (typeValue === 'all' || cardType === typeValue.toLowerCase()) ? '' : 'none';
        });
        if (priceValue === 'low' || priceValue === 'high') {
            var visible = cards.filter(function(c) { return c.style.display !== 'none'; });
            visible.sort(function(a, b) {
                var pa = parseInt(a.getAttribute('data-price'));
                var pb = parseInt(b.getAttribute('data-price'));
    ...
    function updateThemeIcon() {
        ...
        if (currentTheme === 'dark') {
            ...
            document.getElementById('themeToggle').title = 'Switch to Day Mode';
        } else {
            icon.className = 'fa fa-sun';
            document.getElementById('themeToggle').title = 'Switch to Night Mode';
        }
    }
...
<!-- ════════════════════════════════════════════
     AI CHATBOT WIDGET (all functions unchanged)
════════════════════════════════════════════ -->
<!-- Floating Button -->
...
<div id="chatWindow">
    <div class="chat-header">
        ...
        <div class="chat-header-info">
            ...
            <span><span class="online-dot"></span>Online — Powered by AI</span>
        </div>
    ...
    <div class="chat-input-area">
        <input type="text" id="chatInput" placeholder="Ask about our cars..."
...
<script>
// ── Car data from PHP/DB (no API needed) ─────────────────────────────────
...
function carLine(car) {
    return `🚗 <strong>${car.car_name}</strong> (${car.car_model || ''}) — ${fmt(car.price_per_day)}/day | ${car.car_type} | ${car.seating_capacity || 4} seats`;
}

function getBotReply(msg) {
    const t = msg.toLowerCase().trim();
    if (/^(hi|hello|hey|good (morning|evening|afternoon)|howdy)/.test(t)) {
        return "👋 Hi there! Welcome to CarForYou. I can help you find a car, check prices, or compare vehicles. What are you looking for?";
    }
    if (/thank|thanks|thank you/.test(t)) {
        return "😊 You're welcome! Feel free to ask if you need anything else. Happy driving!";
    }
    if (/how.*(book|rent|reserve|hire)|booking process|steps to/.test(t)) {
        return "📋 <strong>How to book:</strong><br>1. Go to <strong>Car Listing</strong> from the top menu<br>2. Browse and click <strong>Book Now</strong> on your chosen car<br>3. Login if you haven't already<br>4. Pick your dates and confirm!<br><br>Need help choosing a car?";
    }
    ...
    if (/premium|luxury|best|top|expensive|high.?end|vip|fancy/.test(t)) {
        const p = premium();
        if (p.length === 0) return "No premium cars found at the moment.";
        let reply = `⭐ <strong>Our Premium Cars:</strong><br><br>`;
        p.slice(0,4).forEach(c => { reply += carLine(c) + '<br>'; });
        reply += `<br>These are our top-tier vehicles. Visit <strong>Car Listing</strong> to book!`;
        return reply;
    }
    if (/cheap|budget|affordable|low.?price|cheapest|economical|least expensive|low cost/.test(t)) {
        const b = budget();
        if (b.length === 0) return "No budget cars found at the moment.";
        let reply = `💰 <strong>Budget-Friendly Cars:</strong><br><br>`;
        b.slice(0,4).forEach(c => { reply += carLine(c) + '<br>'; });
        reply += `<br>Great value options! Head to <strong>Car Listing</strong> to book.`;
        return reply;
    }
    if (/electric|ev|zero emission/.test(t)) {
        const ev = CAR_DATA.filter(c => /electric/i.test(c.car_type));
        if (ev.length === 0) return "⚡ We don't have any electric cars available right now. Check back soon!";
        let reply = `⚡ <strong>Electric Cars:</strong><br><br>`;
        ev.forEach(c => { reply += carLine(c) + '<br>'; });
        return reply;
    }
    if (/hybrid/.test(t)) {
        const h = CAR_DATA.filter(c => /hybrid/i.test(c.car_type));
        if (h.length === 0) return "🌿 No hybrid cars available right now.";
        let reply = `🌿 <strong>Hybrid Cars:</strong><br><br>`;
        h.forEach(c => { reply += carLine(c) + '<br>'; });
        return reply;
    }
    if (/eco|green|fuel.?efficient|environment/.test(t)) {
        const eco = CAR_DATA.filter(c => /hybrid|electric/i.test(c.car_type));
        if (eco.length === 0) return "🌱 No eco-friendly cars available right now.";
        let reply = `🌱 <strong>Eco-Friendly Cars (Hybrid & Electric):</strong><br><br>`;
        eco.forEach(c => { reply += carLine(c) + '<br>'; });
        return reply;
    }
    if (/petrol|gasoline/.test(t)) {
        const p = CAR_DATA.filter(c => /petrol/i.test(c.car_type));
        if (p.length === 0) return "No petrol cars available right now.";
        let reply = `⛽ <strong>Petrol Cars:</strong><br><br>`;
        p.forEach(c => { reply += carLine(c) + '<br>'; });
        return reply;
    }
    if (/diesel/.test(t)) {
        const d = CAR_DATA.filter(c => /diesel/i.test(c.car_type));
        if (d.length === 0) return "No diesel cars available right now.";
        let reply = `🛢️ <strong>Diesel Cars:</strong><br><br>`;
        d.forEach(c => { reply += carLine(c) + '<br>'; });
        return reply;
    }
    if (/price|cost|rate|how much|per day|daily rate|charges/.test(t)) {
        ...
        let reply = `💵 <strong>Our Price Range:</strong><br><br>`;
        reply += `• Lowest: <strong>${fmt(minPrice())}/day</strong><br>`;
        reply += `• Highest: <strong>${fmt(maxPrice())}/day</strong><br><br>`;
        reply += `<strong>All Cars by Price:</strong><br>`;
        const sorted = [...CAR_DATA].sort((a,b) => a.price_per_day - b.price_per_day);
        sorted.forEach(c => { reply += `${c.car_name} — ${fmt(c.price_per_day)}/day<br>`; });
        return reply;
    }
    if (/seat|passenger|family|people|group|capacity|how many/.test(t)) {
        if (CAR_DATA.length === 0) return "No cars available right now.";
        const sorted = [...CAR_DATA].sort((a,b) => (b.seating_capacity||4) - (a.seating_capacity||4));
        let reply = `👨‍👩‍👧 <strong>Cars by Seating Capacity:</strong><br><br>`;
        sorted.forEach(c => { reply += `🚗 <strong>${c.car_name}</strong> — ${c.seating_capacity || 4} seats | ${fmt(c.price_per_day)}/day<br>`; });
        return reply;
    }
    const matchedCar = CAR_DATA.find(c => t.includes(c.car_name.toLowerCase()) || (c.car_model && t.includes(c.car_model.toLowerCase())));
    if (matchedCar) {
        return `🚗 <strong>${matchedCar.car_name}</strong><br><br>` +
            `📅 Year/Model: ${matchedCar.car_model || 'N/A'}<br>` +
            `⛽ Fuel: ${matchedCar.car_type}<br>` +
            `👥 Seats: ${matchedCar.seating_capacity || 4}<br>` +
            `💵 Price: <strong>${fmt(matchedCar.price_per_day)}/day</strong><br><br>` +
            `📝 ${matchedCar.car_overview || 'Premium rental vehicle available now.'}<br><br>` +
            `👉 Go to <strong>Car Listing</strong> to book this car!`;
    }
    if (/recommend|suggest|which car|best car|good car|what.*should|help.*choose/.test(t)) {
        const p = premium(); const b = budget();
        let reply = `😊 Happy to help! Here's a quick recommendation:<br><br>`;
        if (p.length > 0) reply += `⭐ <strong>Premium pick:</strong> ${p[0].car_name} — ${fmt(p[0].price_per_day)}/day<br>`;
        if (b.length > 0) reply += `💰 <strong>Budget pick:</strong> ${b[0].car_name} — ${fmt(b[0].price_per_day)}/day<br>`;
        reply += `<br>Tell me your budget or purpose (trip, wedding, family) and I'll narrow it down!`;
        return reply;
    }
    if (/contact|phone|call|email|address|location|office|reach/.test(t)) {
        return `📞 <strong>Contact CarForYou:</strong><br><br>📱 Phone: +94 75 45 57 624<br>✉️ Email: amafzhar@gmail.com<br>📍 37 Kinniya, Trincomalee, Sri Lanka<br><br>Or use the <strong>Contact Us</strong> page from the menu!`;
    }
    if (/about|company|who are you|carforyou|history|experience/.test(t)) {
        return `🏢 <strong>About CarForYou:</strong><br><br>We are a premium car rental company in Sri Lanka with <strong>40+ years</strong> of experience and a fleet of <strong>1200+ vehicles</strong>.<br><br>We offer fully insured cars, 24/7 support, and the best prices — no hidden charges!`;
    }
    if (/open|hours|timing|when|available|24/.test(t)) {
        return `🕐 We offer <strong>24/7 support</strong> for our customers. You can book a car anytime through our website!`;
    }
    if (/bye|goodbye|see you|later|take care/.test(t)) {
        return "👋 Goodbye! Have a great drive. Come back anytime — CarForYou is always here for you! 🚗";
    }
    return `🤔 I'm not sure about that, but I can help you with:<br><br>
🚗 <strong>All Cars</strong> — type "show all cars"<br>
⭐ <strong>Premium Cars</strong> — type "premium cars"<br>
💰 <strong>Budget Cars</strong> — type "cheap cars"<br>
💵 <strong>Prices</strong> — type "what are your prices"<br>
📋 <strong>Booking</strong> — type "how to book"<br>
📞 <strong>Contact</strong> — type "contact info"<br><br>
Or browse our <strong>Car Listing</strong> page directly!`;
}
...
function toggleChat() {
    ...
    if (win.classList.contains('open') && !chatOpened) {
        chatOpened = true;
        setTimeout(() => {
            addMessage('bot', "👋 Hi! I'm the CarForYou assistant. I can help you find cars, check prices, and answer questions — all for free! What are you looking for today?");
        }, 300);
    }
...
function addMessage(role, text) {
    ...
    div.innerHTML = '<div class="msg-avatar">' + initial + '</div><div class="msg-bubble">' + text + '</div>';
